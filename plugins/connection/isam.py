...
class Connection(NetworkConnectionBase):
 ...
 :returns: dict, return value(s) from the api call
        ...
        try:
            ...
            raise AnsibleConnectionFailure('Error> action ' + method_name + ' belongs to a module that is not found!', isam_module, e)
        except AttributeError as e:
            raise AnsibleConnectionFailure('Error> invalid action ' + method_name + ' was specified, method not found in module!',
                                           isam_module, e)
        except TypeError as e:
            raise AnsibleConnectionFailure(
                'Error> action ' + method_name + ' does not have the right set of arguments or there is a code bug! Options: ' + options,
                isam_module, e)
